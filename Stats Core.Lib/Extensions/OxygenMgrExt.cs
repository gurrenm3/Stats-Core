...
namespace Stats_Core.Extensions
{
    public static class OxygenMgrExt
    {
        ...
        public static void SetO2UnitsPerSecondSurface(this OxygenManager oxygenManager, float amount) => oxygenManager.oxygenUnitsPerSecondSurface = amount;
        ...
        public static void SetBreathPeriod(this OxygenManager oxygenManager, float amount) => Air.BreathPeriod = amount;
        ...
        public static void SetOxygenPerBreath(this OxygenManager oxygenManager, float amount) => Air.OxygenPerBreath = amount;
        ...
        public static void SetSuffocationTime(this OxygenManager oxygenManager, float amount) => Air.SuffocationTime = amount;
        ...
        public static void SetSuffocationRecoveryTime(this OxygenManager oxygenManager, float amount) => Air.SuffocationRecoveryTime = amount;
    }
}