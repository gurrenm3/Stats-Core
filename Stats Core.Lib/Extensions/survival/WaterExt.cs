...
namespace Stats_Core.Extensions
{
    public static partial class SurvivalExt
    {
        ...
        public static void SetStartingWater(this Survival survival, float amount) => Water.StartingWater = amount;
        ...
        public static void SetMinWater(this Survival survival, float amount) => Water.MinWater = amount;
        ...
        public static void SetWaterCapacity(this Survival survival, float amount) => Water.WaterCapacity = amount;
        ...
        public static void SetWaterOverfillSize(this Survival survival, float amount) => Water.OverfillWaterSize = amount;
        ...
        public static void SetWaterTime(this Survival survival, float amount) => Water.WaterTime = amount;
        ...
        public static void SetDehydrationDamage(this Survival survival, float amount) => Water.DehydrationDamage = amount;
        ...
        public static void SetLowWaterThreshold(this Survival survival, float amount) => Water.LowWaterThreshold = amount;
        ...
        public static void SetCriticalWaterThreshold(this Survival survival, float amount) => Water.CriticalWaterThreshold = amount;
    }
}